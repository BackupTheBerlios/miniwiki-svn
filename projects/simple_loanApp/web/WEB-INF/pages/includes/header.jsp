...
<head>
    ...
    <link href="<c:url value="/styles/custom_style.css"/>" rel="stylesheet" type="text/css" />
    <script type="text/javascript" src="<c:url value="/scripts/jquery.js" />"></script>
    <script type="text/javascript" src="<c:url value="/scripts/jquery_form.js"/>"></script>
</head>
<body>
...
<div id="container">
    ...
    <ul id="navPyra">
      ...
      <li><a <c:if test="${'6' eq param.menuId}">class="active"</c:if> href="<c:url value="/applyLoan.view"/>"><fmt:message key="header.menu.applyNow"/></a></li>
