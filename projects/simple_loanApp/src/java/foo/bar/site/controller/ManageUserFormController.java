...
public class ManageUserFormController extends DefaultFormController {
    ...
    protected void onSubmitFailure(HttpServletRequest request, HttpServletResponse response, Object command, BindException bindException) {
        super.onSubmitFailure(request, response, command, bindException);    //To change body of overridden methods use File | Settings | File Templates.
    }
    ...
    protected void onSubmitSuccess(HttpServletRequest request, HttpServletResponse response, Object command, BindException bindException) {
        super.onSubmitSuccess(request, response, command, bindException);    //To change body of overridden methods use File | Settings | File Templates.
    }
