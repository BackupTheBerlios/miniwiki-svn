...
CREATE TABLE TBL_ATTACHEMENT (ID BIGINT NOT NULL, ATTACHMENT BLOB NOT NULL, CONTENT_TYPE VARCHAR(255) NOT NULL, VERSION INTEGER, PAGE_ID BIGINT, PRIMARY KEY (ID), UNIQUE (ID)) TYPE = innodb;
...
CREATE TABLE TBL_PAGE_PRIVILEDGE (ID BIGINT NOT NULL, VERSION INTEGER, PAGE_ID BIGINT, PRIMARY KEY (ID), UNIQUE (ID)) TYPE = innodb;
...
CREATE TABLE TBL_PREVIOUS_VERSION (ID BIGINT NOT NULL, VERSION INTEGER, PAGE_ID BIGINT, USER_ID BIGINT, PRIMARY KEY (ID), UNIQUE (ID)) TYPE = innodb;
...
CREATE TABLE TBL_SPACE_PRIVILEDGE (ID BIGINT NOT NULL, VERSION INTEGER, SPACE_ID BIGINT, PRIMARY KEY (ID), UNIQUE (ID)) TYPE = innodb;
...
CREATE TABLE TBL_WIKI (ID BIGINT NOT NULL, VERSION INTEGER, PRIMARY KEY (ID), UNIQUE (ID)) TYPE = innodb;
