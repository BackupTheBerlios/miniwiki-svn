...
public class UserManagementServiceTest extends AbstractDbTestCase {
                    ...
                    public void action(JpaTemplate template) throws Exception {
                        template.execute(new JpaCallback() {
                            public Object doInJpa(EntityManager entityManager) throws PersistenceException {
                                ...
                                assertEquals(16l, q.getSingleResult());
    ...
    public void testAuthenticate() throws Exception {
        ...
        {   // user 4 is not enable, we should not be able to authenticate
            UiCredentials credentials = userManagementService.authenticate("User4", "User4_Password");
        ...
        }
        {
            ...
            assertEquals(true, credentials.getUser().isEnabled());
            ...
            assertEquals(group1Users.get(0).isEnabled(), true);
            ...
            assertEquals(group1Users.get(1).isEnabled(), true);
    ...
    public void testGetAllUser() throws Exception {
        List<UiUser> users = getUserManagementService().getAllUsers(new PagingInfo(1, 100)).getUsers();
        Collections.sort(users, new UiUserUsernameComparator());

        assertEquals(16, users.size());
        assertEquals("Jim", users.get(0).getUsername());
        assertEquals("Toby", users.get(1).getUsername());
        assertEquals("User1", users.get(2).getUsername());
        assertEquals("User10", users.get(3).getUsername());
        assertEquals("User11", users.get(4).getUsername());
        assertEquals("User12", users.get(5).getUsername());
        assertEquals("User13", users.get(6).getUsername());
        assertEquals("User14", users.get(7).getUsername());
        assertEquals("User2", users.get(8).getUsername());
        assertEquals("User3", users.get(9).getUsername());
        assertEquals("User4", users.get(10).getUsername());
        assertEquals("User5", users.get(11).getUsername());
        assertEquals("User6", users.get(12).getUsername());
        assertEquals("User7", users.get(13).getUsername());
        assertEquals("User8", users.get(14).getUsername());
        assertEquals("User9", users.get(15).getUsername());
    }
    ...
    public void testSearchForGroupNotExact() throws Exception {
        ...
        assertEquals(groups.get(0).getName(), "Group1");
        assertEquals(groups.get(0).isEnabled(), true);
        assertEquals(groups.get(0).getDescription(), "Group1_Description");
        assertEquals(groups.get(0).getProperties().size(), 3);
        assertEquals(groups.get(0).getUsers().size(), 2);
        assertEquals(groups.get(1).getName(), "Group2");
        assertEquals(groups.get(1).isEnabled(), true);
        assertEquals(groups.get(1).getDescription(), "Group2_Description");
        assertEquals(groups.get(1).getProperties().size(), 2);
        assertEquals(groups.get(1).getUsers().size(), 1);
        assertEquals(groups.get(2).getName(), "Group3");
        assertEquals(groups.get(2).isEnabled(), true);
        ...
        assertEquals(groups.get(3).isEnabled(), false);
    ...
    public void testGetAllGroups() throws Exception {
        List<UiGroup> group_page1 = getUserManagementService().getAllGroups(new PagingInfo(1, 100)).getGroups();
    ...
    public void testUpdateUser() throws Exception {
        ...
        // user group
        List<UiGroup> tobyGroups = new ArrayList<UiGroup>(user.getGroups());
        ...
        // user group
        tobyGroups = new ArrayList<UiGroup>(user.getGroups());
        Collections.sort(tobyGroups, new UiGroupNameComparator());
        assertEquals(3, tobyGroups.size());
        assertEquals("Group1", tobyGroups.get(0).getName());
        //assertEquals("Group2", tobyGroups.get(1).getName());
    ...
    public void testDeleteUser() throws Exception {
        ...
        assertEquals(0, group2Users.size());
    }
